				...
				<div class="row">
					...
					<div class="col-sm-9">
						...
						<div class="beta-products-list">
							...
							<div class="row">
								@foreach($sp_khac as $sp_khacc)
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp_khacc->id)}}"><img src="source/image/product/{{$sp_khacc->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$sp_khacc->name}}</p>
											@if($sp_khacc->promotion_price==0)
												<span class="flash-sale" style="font-size: 18px">{{number_format($sp_khacc->unit_price)}} đồng</span>
												@else
												<span class="flash-del" style="font-size: 18px">{{number_format($sp_khacc->unit_price)}} đồng</span>
												<span class="flash-sale" style="font-size: 18px">{{number_format($sp_khacc->promotion_price)}} đồng</span>
												@endif
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
