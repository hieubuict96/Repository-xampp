			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
						<li>Tài khoản ({{Auth::user()->full_name}})</li>
					...
					<div class="beta-comp">
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									<a class="cart-item-delete" href="{{route('xoagiohang',$product['item']['id'])}}"><i class="fa fa-times"></i></a><!-- $product['item'] tương đương với mảng các sản phẩm trong bảng products trong database -->
									<div class="media">
										<a class="pull-left" href="#"><img src="source/image/product/{{$product['item']['image']}}" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">{{$product['item']['name']}}</span>
											@if($product['item']['promotion_price']!=0)
											<span class="flash-del">{{$product['qty']}}*<span>{{$product['item']['unit_price']}}</span></span>
											@endif
								...
								<div class="cart-caption">
									...
									<div class="center">
										<div class="space10">&nbsp;</div>
										<a href="{{route('dathang1')}}" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div> <!-- .cart -->
